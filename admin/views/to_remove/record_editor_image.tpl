<form id="editImageForm" style="margin:0px;" method="post" enctype="multipart/form-data" action="/<?php echo $this->pagename ?>/?jqueryform=recordimage">
...
<tr><td align="center" valign="middle">
	<img src="<?php echo '/'.SE_DIR.$record->image ?>" border=0>
</td></tr>
<tr><td>
	<div>&nbsp;</div>
</td></tr>
