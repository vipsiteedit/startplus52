...
<form style="margin:0px;" method="post" action="<?php echo getRequest('page').'?'.time() ?>">
 ...
 <tr valign="top" align="left">
  <td class="ttltd"><div><b>Вводный текст</b></div>
		<textarea id="editenteringtext" class="field_arr" name="enteringtext" rows="10" cols="40"><?php echo htmlspecialchars($this->page->enteringtext) ?></textarea>
  </td>
 </tr> 
...
$(document).ready(function(){
 var wsize = windowWorkSize(),                             
    testElem = document.getElementById("cont_txt_edit"),                     
    testElemWid =  testElem.offsetWidth,                                    
    testElemHei =  testElem.offsetHeight;                                  
	testElem.style.left = wsize[0]/2 - testElemWid/2 + "px";        
	testElem.style.top = wsize[1]/2 - testElemHei/2 + (document.body.scrollTop || document.documentElement.scrollTop) + "px";
