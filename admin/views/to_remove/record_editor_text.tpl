<form id="editTextForm" style="margin:0px;" method="post" action="/<?php echo $this->pagename ?>/?jqueryform=recordtext">
...
<tr><td>
	...
	<input type="hidden" id="recid" name="recid" value="<?php echo $record->id ?>">
		<textarea mce_editable="true" id="editrectext" style="width:100%" class="field_note" name="rectext" rows="20" cols="60"><?php echo htmlspecialchars($record->text) ?></textarea>
	</td></tr>
	<tr><td>
