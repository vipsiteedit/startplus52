...
file_put_contents(dirname(__FILE__).'/post.txt',json_encode($_POST));
include('upload.php');
...
if(isset($_GET['elang']) && $_GET['elang'] != 'undefined' && $_GET['elang']!='')
    $lang=$_GET['elang'];
...
<html xmlns="https://www.w3.org/1999/xhtml">
	...
	<link rel="shortcut icon" href="/admin/filemanager/img/ico/favicon.ico">
        <link href="/admin/filemanager/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="/admin/filemanager/css/bootstrap-responsive.min.css" rel="stylesheet" type="text/css" />
        <link href="/admin/filemanager/css/bootstrap-lightbox.min.css" rel="stylesheet" type="text/css" />
        <link href="/admin/filemanager/css/style.css" rel="stylesheet" type="text/css" />
	<link href="/admin/filemanager/css/dropzone.min.css" type="text/css" rel="stylesheet" />
	<link href="/admin/filemanager/css/jquery.contextMenu.min.css" rel="stylesheet" type="text/css" />	
	<link href="/admin/filemanager/css/bootstrap-modal.min.css" rel="stylesheet" type="text/css" />
	<link href="/admin/filemanager/jPlayer/skin/blue.monday/jplayer.blue.monday.css" rel="stylesheet" type="text/css">
	<!--[if lt IE 8]><style>
	...
	if (typeof jQuery === 'undefined')
	{
	  document.write(unescape("%3Cscript src='js/jquery.js' type='text/javascript'%3E%3C/script%3E"));
        ...
        <script type="text/javascript" src="/admin/filemanager/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="/admin/filemanager/js/bootstrap-lightbox.min.js"></script>
	<script type="text/javascript" src="/admin/filemanager/js/dropzone.min.js"></script>
	<script type="text/javascript" src="/admin/filemanager/js/jquery.touchSwipe.min.js"></script>
	<script type="text/javascript" src="/admin/filemanager/js/modernizr.custom.js"></script>
	<script type="text/javascript" src="/admin/filemanager/js/bootbox.min.js"></script>
	<script type="text/javascript" src="/admin/filemanager/js/bootstrap-modal.min.js"></script>   
	<script type="text/javascript" src="/admin/filemanager/js/bootstrap-modalmanager.min.js"></script>
	<script type="text/javascript" src="/admin/filemanager/jPlayer/jquery.jplayer.min.js"></script>
	<script type="text/javascript" src="/admin/filemanager/js/imagesloaded.pkgd.min.js"></script>
	<script type="text/javascript" src="/admin/filemanager/js/jquery.queryloader2.min.js"></script>
	<?php
	if($aviary_active){
	...
	<![endif]-->
	<script src="/admin/filemanager/js/jquery.ui.position.min.js" type="text/javascript"></script>
	<script src="/admin/filemanager/js/jquery.contextMenu.min.js" type="text/javascript"></script>    
	...
	<script>
	    ...
	    Dropzone.options.myAwesomeDropzone = {
		    ...
		    url: "<?php echo $fm_path; ?>?filemanager=upload",
		...
		language: "<?php echo $aviary_language; ?>",
	       ...
	       onSave: function(imageID, newURL) {
		    ...
		    $.ajax({
			type: "POST",
			url: "<?php echo $fm_path; ?>?filemanager=ajax_calls&action=save_img",
	...
	<script type="text/javascript" src="<?php echo $fm_path; ?>?filemanager=include_js&<?php echo time(); ?>"></script>
    </head>
    <body>
	...
	<input type="hidden" id="fm_path" value="<?php echo $fm_path ?>"/>
...
<div class="uploader">
	...
	<div class="tabbable upload-tabbable">
		...
		<div class="tab-pane active" id="tab1">
		    <?php } ?>
		<form action="<?php echo $fm_path; ?>?filemanager" method="post" enctype="multipart/form-data" id="myAwesomeDropzone" class="dropzone">
...
<!----- header div end ------->
    ...
    <div class="row-fluid">
	<?php	
	$link= $fm_path."?filemanager&".$get_params;
	?>
	<ul class="breadcrumb">	
	...
	?>
	<li class="pull-right"><a id="refresh" class="btn-small" href="<?php echo $fm_path; ?>?filemanager&<?php echo $get_params.$subdir."&".uniqid() ?>"><i class="icon-refresh"></i></a></li>
		...
		foreach ($files as $file_array) {
			...
			<li data-name="<?php echo $file ?>" <?php if($file=='..') echo 'class="back"'; else echo 'class="dir"'; ?>>
				<figure data-name="<?php echo $file ?>" class="<?php if($file=="..") echo "back-"; ?>directory" data-type="<?php if($file!=".."){ echo "dir"; } ?>">
				    <a class="folder-link" href="<?php echo $fm_path; ?>?filemanager&<?php echo $get_params.rawurlencode($src)."&".uniqid() ?>">
				    <div class="img-precontainer">
					<div class="img-container directory"><span></span>
					<img class="directory-img"  src="/admin/filemanager/img/<?php echo $icon_theme; ?>/folder<?php if($file==".."){ echo "_back"; }?>.jpg" alt="folder" />
					</div>
				    </div>
				    <div class="img-precontainer-mini directory">
					<div class="img-container-mini">
					    <span></span>
					    <img class="directory-img"  src="/admin/filemanager/img/<?php echo $icon_theme; ?>/folder<?php if($file==".."){ echo "_back"; }?>.png" alt="folder" />
					</div>
				    </div>
			<?php if($file==".."){ ?>
			...
			<?php }else{ ?>
				    ...
				    <div class="box">
					<h4 class="<?php if($ellipsis_title_after_first_row){ echo "ellipsis"; } ?>"><a class="folder-link" data-file="<?php echo $file ?>" href="<?php echo $fm_path; ?>?filemanager&<?php echo $get_params.rawurlencode($src)."&".uniqid() ?>"><?php echo $file; ?></a></h4>
				    </div>
			...
			$file=$file_array['file'];
			    ...
			    if($src_thumb==""){
				$no_thumb=true;
				if(file_exists(SE_ROOT.'admin/filemanager/img/'.$icon_theme.'/'.$extension_lower.".jpg")){
					$src_thumb ='/admin/filemanager/img/'.$icon_theme.'/'.$extension_lower.".jpg";
				}else{
					$src_thumb = "/admin/filemanager/img/".$icon_theme."/default.jpg";
				}
				$is_icon_thumb=true;
			    }
			    if($mini_src==""){
...
?>
		<li class="ff-item-type-<?php echo $class_ext; ?> file"  data-name="<?php echo $file; ?>">
			<figure data-name="<?php echo $file ?>" data-type="<?php if($is_img){ echo "img"; }else{ echo "file"; } ?>">
				...
				<figcaption>
				    <form action="<?php echo $fm_path; ?>?filemanager=force_download" method="post" class="download-form" id="form<?php echo $nu; ?>">
					...
					title="<?php echo lang_Preview?>" data-url="<?php echo $fm_path; ?>?filemanager=ajax_calls&action=media_preview&title=<?php echo $filename; ?>&file=<?php echo $current_path.$subfolder.$subdir.$file;; ?>"
    ...
    <div id="loading_container" style="display:none;">
	    ...
	    <img id="loading_animation" src="/admin/filemanager/img/storing_animation.gif" alt="loading" style="z-index:10001; margin-left:-32px; margin-top:-32px; position:fixed; left:50%; top:50%"/>
    </div>
    <!----- loading div end ------->
