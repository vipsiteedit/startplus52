<?php
if (!defined('SE_INDEX_INCLUDED')) exit;
if (!$this->editorAccess()) exit;
//------------------------------------------------------------------------------
...
//$base_url="";
$add = $base_url = "";
if ($_SESSION['editor_images_access'] != 'admin' && (seUserGroup() != 3))
    $add = $_SESSION['editor_images_access'].'/';
$upload_dir = 'images/'.$add; // path from base_url to base of upload folder (with start and final /)
$current_path = SE_DIR.'images/'.$add; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = 'thumbs/'.$add; // relative path from filemanager folder to thumbs folder (with final /)

//$fm_path = '/'.SE_MULTI_DIR;
$fm_path = '';
