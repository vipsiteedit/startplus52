...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/lib/imanager/css/imanager.css" />
	...
	<!-- /SWFUpload -->
	<script type="text/javascript" src="/lib/imanager/js/images.js"></script>
</head>
<body>
<?php
  ...
  <form id="form1" action="<?php echo $path ?>connector.php" method="post" enctype="multipart/form-data">
   ...
   <script>
	...
	function setWidth(width){
	   $.post('<?php echo $path ?>connector.php', {action: 'changewidth' ,maxwidth: width});
	}
   ...
   <select id="maxwidth" name="maxwidth" id="maxsize" onChange="setWidth(this.value);">
	...
	<option value="800">800px</option>
			...
			<div id="btnsBar">
			 ...
			 <input id="btnComplete" type="button" value="Отменить все загрузки" disabled="disabled" />
			</div>
